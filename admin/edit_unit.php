...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="unitName" class="form-control mt-2" name="txtUnitName" placeholder="Unit Name" value="<?php echo $row_selectUnitDetails['unit_name']; ?>" required /> </div> <span class="error_message"><?php echo $unitNameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="unitDetails">Details</label> </div>
			<div class="input-box"><textarea id="unitDetails" class="form-control mt-2" name="txtunitDetails" placeholder="Details"><?php echo $row_selectUnitDetails['unit_details']; ?></textarea> </div>
		</li>
		<li>
			<input type="submit" value="Update Unit" class="btn btn-success mt-2" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
