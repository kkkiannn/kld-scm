		...
		<form action="" method="POST" class="form">
			<ul class="form-list">
				<li>
					...
					<div class="input-box"> <input class="mt-2 form-control" type="password" id="oldPassword" name="txtOldPassword" placeholder="Old Password" required /> </div> <span class="error_message"><?php echo $oldPasswordErr; ?></span>
				</li>
				<li>
					<div class="label-block"> <label for="newPassword">New Password</label> </div>
					<div class="input-box"> <input class="mt-2 form-control" type="password" id="newPassword" name="txtNewPassword" placeholder="New Password" required /> </div>
				</li>
				<li>
					<div class="label-block mt-4"> <label for="confirmPassword">Confirm Password</label> </div>
					<div class="input-box"> <input class="mt-2 form-control" type="password" id="confirmPassword" name="txtConfirmPassword" placeholder="Confirm Password" required /> </div><span class="error_message"><?php echo $matchErr; ?></span>
				</li>
				<li>
					<input type="submit" value="Change Password" class="btn btn-success" /> <span class="error_message"> <?php echo $requireErr; ?>
				</li>
			</ul>
		</form>
	</section>
