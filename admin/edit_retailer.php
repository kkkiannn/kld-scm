...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="retailer:username" class="mt-2 form-control" name="txtRetailerUname" placeholder="Username" value="<?php echo $row_selectRetailerDetails['username']; ?>" required /> </div> <span class="error_message"><?php echo $usernameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="retailer:areaCode">Zip Code</label> </div>
			<div class="input-box">
				<select class="mt-2 form-control" name="cmbAreaCode" id="retailer:areaCode">
		...
		<li>
			...
			<div class="input-box"> <input class="mt-2 form-control" type="text" id="retailer:phone" name="txtRetailerPhone" placeholder="Phone" value="<?php echo $row_selectRetailerDetails['phone']; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="retailer:email">Email</label> </div>
			<div class="input-box"> <input class="mt-2 form-control" type="text" id="retailer:email" name="txtRetailerEmail" placeholder="Email" value="<?php echo $row_selectRetailerDetails['email']; ?>" required /> </div> <span class="error_message"><?php echo $emailErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="retailer:address">Address</label> </div>
			<div class="input-box"> <textarea class="mt-2 form-control" type="text" id="retailer:address" name="txtRetailerAddress" placeholder="Address"><?php echo $row_selectRetailerDetails['address']; ?></textarea> </div>
		</li>
		<li>
			<input type="submit" value="Update Retailer" class="btn btn-success mt-3" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
