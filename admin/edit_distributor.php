...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="distributor:name" class="form-control mt-2" name="txtDistributorName" placeholder="Name" value="<?php echo $row_selectDistDetails['dist_name']; ?>" required /> </div> <span class="error_message"><?php echo $nameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="distributor:email">Email</label> </div>
			<div class="input-box"> <input type="text" id="distributor:email" class="form-control mt-2" name="txtDistributorEmail" placeholder="Email" value="<?php echo $row_selectDistDetails['dist_email']; ?>" required /> </div> <span class="error_message"><?php echo $emailErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="distributor:phone">Phone</label> </div>
			<div class="input-box"> <input type="text" id="distributor:phone" class="form-control mt-2" name="txtDistributorPhone" placeholder="Phone" value="<?php echo $row_selectDistDetails['dist_phone']; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="distributor:address">Address</label> </div>
			<div class="input-box"> <textarea type="text" id="distributor:address" class="form-control mt-2" name="txtDistributorAddress" placeholder="Address"><?php echo $row_selectDistDetails['dist_address']; ?></textarea> </div>
		</li>
		<li>
			<input type="submit" value="Update Manufacturer" class="btn btn-success mt-3" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
