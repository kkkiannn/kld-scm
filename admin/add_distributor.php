...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" class="form-control mt-2" id="distributor:name" name="txtDistributorName" placeholder="Name" value="<?php echo $nameHolder; ?>" required /> </div> <span class="error_message"><?php echo $nameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="distributor:email">Email</label> </div>
			<div class="input-box"> <input type="text" class="form-control mt-2" id="distributor:email" name="txtDistributorEmail" placeholder="Email" value="<?php echo $emailHolder; ?>" required /> </div> <span class="error_message"><?php echo $emailErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="distributor:phone">Phone</label> </div>
			<div class="input-box"> <input type="text" class="form-control mt-2" id="distributor:phone" name="txtDistributorPhone" placeholder="Phone" value="<?php echo $phoneHolder; ?>" /> </div> <span class="error_message"><?php echo $phoneErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="distributor:address">Address</label> </div>
			<div class="input-box"> <textarea type="text" class="form-control mt-2" id="distributor:address" name="txtDistributorAddress" placeholder="Address"><?php echo $addressHolder; ?></textarea> </div>
		</li>
		<li>
			<input type="submit" value="Add Distributor" class="btn btn-success mt-3" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
