...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="areaName" class="form-control mt-2" name="txtAreaName" placeholder="Area Name" value="<?php echo $row_selectAreaDetails['area_name']; ?>" required /> </div> <span class="error_message"><?php echo $areaNameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="areaCode">Zip Code</label> </div>
			<div class="input-box"> <input type="text" id="areaCode" class="form-control mt-2" name="txtAreaCode" placeholder="Area Code" value="<?php echo $row_selectAreaDetails['area_code']; ?>" required /> </div>
		</li>
		<li>
			<input type="submit" value="Update Area" class="btn btn-success mt-3" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
