...
<body>
	...
	<section>
		...
		<form action="" method="POST" class="form">
			Search By:
			<div class="input-box">
				<select name="cmbFilter" class="form-control mt-2" id="cmbFilter">
			...
			<div class="input-box"> <input type="text" class="form-control mt-2" name="txtId" id="txtId" style="display:none;" /> </div>
			<div class="input-box">
				<select name="cmbRetailer" class="form-control mt-2" id="cmbRetailer" style="display:none;">
			...
			<div class="input-box"> <input type="text" id="datepicker" placeholder="Select date" class="form-control mt-2" name="txtDate" style="display:none;" /> </div>
			<div class="input-box">
				<select name="cmbStatus" class="form-control mt-2" id="cmbStatus" style="display:none;">
			...
			<div class="input-box">
				<select name="cmbApproved" class="form-control mt-2" id="cmbApproved" style="display:none;">
					<option value="" disabled selected>-- Select Option --</option>
			...
			<input type="submit" class="btn btn-success mt-2" value="Search" /> <span class="error_message"> <?php echo $error; ?> </span>
		</form>
		<form action="" method="POST" class="form">
