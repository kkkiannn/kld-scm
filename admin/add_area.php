...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" class="form-control mt-2" id="areaName" name="txtAreaName" placeholder="Area Name" value="<?php echo $areaNameHolder; ?>" required /> </div> <span class="error_message"><?php echo $areaNameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="areaCode">Area Code</label> </div>
			<div class="input-box"> <input type="text" class="form-control mt-2" id="areaCode" name="txtAreaCode" placeholder="Area Code" value="<?php echo $areaCodeHolder; ?>" required /> </div>
		</li>
		<li>
			<input type="submit" value="Add Area" class="btn btn-success mt-3" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
