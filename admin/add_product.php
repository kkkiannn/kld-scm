		...
		<form action="" method="POST" class="form">
			<ul class="form-list">
				<li>
					...
					<div class="input-box"> <input type="text" class="form-control mt-2" id="product:name" name="txtProductName" placeholder="Product Name" value="<?php echo $nameHolder; ?>" required /> </div> <span class="error_message"><?php echo $nameErr; ?></span>
				</li>
				<li>
					<div class="label-block"> <label for="product:price">Price</label> </div>
					<div class="input-box"> <input type="text" class="form-control mt-2" id="product:price" name="txtProductPrice" placeholder="Price" value="<?php echo $priceHolder; ?>" required /> </div> <span class="error_message"><?php echo $priceErr; ?></span>
				</li>
				<li>
					<div class="label-block"> <label for="product:unit">Unit Type</label> </div>
					<div class="input-box">
						<select name="cmbProductUnit" class="form-control mt-2" id="product:unit">
				...
				<li>
					<div class="label-block mt-3"> <label for="product:category">Material</label> </div>
					<div class="input-box">
				...
				<li>
					...
					<input type="radio" class="form-check-input mx-2" checked name="rdbStock" value="1">Enable
					<input type="radio" class="form-check-input mx-2" name="rdbStock" value="2">Disable
				</li>
				<li>
					<div class="label-block mt-3"> <label for="product:description">Description</label> </div>
					<div class="input-box"> <textarea class="form-control mt-2" type="text" id="product:description" name="txtProductDescription" placeholder="Description"><?php echo $descriptionHolder; ?></textarea> </div>
				</li>
				<li>
					<input type="submit" value="Add Product" class="btn btn-success mt-2" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
				</li>
			</ul>
		</form>
	</section>
