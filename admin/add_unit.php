		...
		<form action="" method="POST" class="form">
			<ul class="form-list">
				<li>
					...
					<div class="input-box"> <input type="text" id="unitName" name="txtUnitName" class="form-control mt-2" placeholder="Unit Name" value="<?php echo $unitNameHolder; ?>" required /> </div> <span class="error_message"><?php echo $unitNameErr; ?></span>
				</li>
				<li>
					<div class="label-block"> <label for="unitDetails">Details</label> </div>
					<div class="input-box"><textarea id="unitDetails" name="txtunitDetails" class="form-control mt-2" placeholder="Details"><?php echo $unitDetailsHolder; ?></textarea> </div>
				</li>
				<li>
					<input type="submit" value="Add Unit" class="btn btn-success mt-2" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
				</li>
			</ul>
		</form>
	</section>
