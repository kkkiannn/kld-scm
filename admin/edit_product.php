...
<body>
	...
	<section>
		...
		<li>
			...
			<div class="input-box"> <input type="text" id="product:name" class="form-control mt-2" name="txtProductName" placeholder="Product Name" value="<?php echo $row_selectProductDetails['pro_name']; ?>" required /> </div> <span class="error_message"><?php echo $nameErr; ?></span>
		</li>
		<li>
			<div class="label-block"> <label for="product:price">Price</label> </div>
			<div class="input-box"> <input type="text" id="product:price" class="form-control mt-2" name="txtProductPrice" placeholder="Price" value="<?php echo $row_selectProductDetails['pro_price']; ?>" required /> </div> <span class="error_message"><?php echo $priceErr; ?></span>
		</li>
		<li>
		<div class="label-block"> <label for="product:unit">Unit Type</label> </div>
		<div class="input-box">
		<select name="cmbProductUnit" id="product:unit" class="form-control mt-2">
		...
		<li>
		<div class="label-block mt-4"> <label for="product:category">Category</label> </div>
		<div class="input-box">
		<select name="cmbProductCategory" class="form-control mt-2" id="product:category">
		...
		<li>
			<div class="label-block mt-3 mb-2"> <label for="product:stock">Stock Management</label> </div>
			<input type="radio" class="mx-2 form-check-input" name="rdbStock" value="1">Enable
			<input type="radio" class="mx-2 form-check-input" name="rdbStock" value="2">Disable
		</li>
		<li>
			<div class="label-block mt-2"> <label for="product:description">Description</label> </div>
			<div class="input-box"> <textarea type="text" class="form-control mt-2" id="product:description" name="txtProductDescription" placeholder="Description"><?php echo $row_selectProductDetails['pro_desc']; ?></textarea> </div>
		</li>
		<li>
			<input type="submit" value="Update Product" class="btn btn-success mt-3" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
