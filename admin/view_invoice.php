...
<body>
	...
	<section>
		...
		<form action="" method="POST" class="form">
			Search By:
			<div class="input-box">
				<select name="cmbFilter" class="form-select" id="cmbFilter">
			...
			<div class="input-box"> <input type="text" name="txtInvoiceId" class="form-control mt-2" id="txtInvoiceId" style="display:none;" /> </div>
			<div class="input-box"> <input type="text" name="txtOrderId" class="form-control mt-2" id="txtOrderId" style="display:none;" /> </div>
			<div class="input-box">
				<select name="cmbRetailer" class="form-select mt-2" id="cmbRetailer" style="display:none;">
