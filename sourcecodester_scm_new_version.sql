...
(12, 'Wood', 'sdfsdkfhjsdf'),
(13, 'Nails', 'sfgfdkhgsdfdsf');
...
(6, 'Kian Torzar', 'kian123@gmail.com', '9013489324', 'Blk13 lot2 brgy san manuel 2');
...
(7, 7, 1, 6, '2024-11-06', 960.000, 'dasfsdfsdfsdf'),
(8, 7, 1, 6, '2024-11-06', 960.000, 'sdfgsdfsdf');
...
(1, 'RL-GPT', 'rl-gpt@gmail.com', '9890234510', 'rl-gpt', 'rlgpt123'),
(2, 'Malupiton Qpal', 'malupitonqpal123@gmail.com', '8980956231', 'malupiton', 'malupiton123');
...
(17, 'Table', 'sdfsdfdsfg', 320.000, 4, 12, 117);
...
(1, 'mherwen', 'mherwen123', 'Dasmarinas City, Cavite', 1, '9978454323', 'mherwen123@gmail.com'),
(2, 'kyle', 'kyle123', 'Bacoor, Cavite', 2, '9898906523', 'kyle123@gmail.com');
...
--
ALTER TABLE `invoice_items`
  MODIFY `invoice_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `order_items`
  MODIFY `order_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
