...
<body>
	...
	<section>
		...
		<form action="" method="POST" class="form">
			...
			<div class="input-box"> <input type="text" class="form-control mt-2" placeholder="Select date" id="datepicker" name="txtDate" style="display:none;" /> </div>
			<div class="input-box">
				<select name="cmbStatus" id="cmbStatus" class="form-control mt-2" style="display:none;">
			...
			<div class="input-box">
				<select name="cmbApproved" id="cmbApproved" class="form-control mt-2" style="display:none;">
					<option value="" disabled selected>-- Select Option --</option>
