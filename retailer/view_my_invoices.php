...
<body>
	...
	<section>
		...
		<form action="" method="POST" class="form">
			...
			<div class="input-box"> <input type="text" class="form-control mt-2" name="txtInvoiceId" id="txtInvoiceId" style="display:none;" /> </div>
			<div class="input-box"> <input type="text" class="form-control mt-2" name="txtOrderId" id="txtOrderId" style="display:none;" /> </div>
			<div class="input-box"> <input type="text" class="form-control mt-2" id="datepicker" name="txtDate" style="display:none;" /> </div>
