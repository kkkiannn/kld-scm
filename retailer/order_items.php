			...
			<table class="table table-bordered table-striped">
				...
				while ($row_selectProducts = mysqli_fetch_array($result_selectProducts)) { ?>
					<tr>
						...
						<td> <input type="text" class="quantity form-control" id="<?php echo $row_selectProducts['pro_id']; ?>" name="<?php echo "txtQuantity" . $row_selectProducts['pro_id']; ?>" /> </td>
						<td>
							<div id="<?php echo "totalPrice" . $row_selectProducts['pro_id']; ?>"></div>
						</td>
					</tr>
				<?php $i++;
				} ?>
				<tr>
					...
					<td> <input type="text" size="10" class="form-control" id="txtFinalAmount" name="total_price" readonly="readonly" value="" /> </td>
				</tr>
			</table>
			<input id="btnSubmit" type="submit" value="Post Order" class="btn btn-success mt-2" />
		</form>
	</section>
	<?php
